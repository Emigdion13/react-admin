...
const Nav = (props: { user: User | null }) => {
    ...
    return (
        ...
        <nav className="bg-dark navbar navbar-dark navbar-expand-lg pb-3 position-relative pt-3 shadow-none" data-pg-collapsed>
            ...
            <div className="container position-relative"> <a className="fw-bold navbar-brand text-uppercase" href="#top">Logo</a>
                ...
                <div className="collapse navbar-collapse " id="navbarNavDropdown-2">
                    <ul className="ms-auto navbar-nav">
                        <li className="nav-item"> <a className="active nav-link pb-lg-3 pe-lg-4 ps-lg-4 pt-lg-3" aria-current="page" href="#top">Home</a>
                        </li>
                        <li className="nav-item"> <a className="nav-link pb-lg-3 pe-lg-4 ps-lg-4 pt-lg-3" href="#top">About</a>
                        </li>
                        <li className="nav-item"> <a className="nav-link pb-lg-3 pe-lg-4 ps-lg-4 pt-lg-3" href="#top">Features</a>
                        </li>
                        <li className="nav-item"> <a className="nav-link pb-lg-3 pe-lg-4 ps-lg-4 pt-lg-3" href="#top">Services</a>
                        </li>
                        <li className="nav-item"> <a className="nav-link pb-lg-3 pe-lg-4 ps-lg-4 pt-lg-3" href="#top">Blog</a>
                        </li>
                        <li className="nav-item"> <a className="nav-link pb-lg-3 pe-lg-4 ps-lg-4 pt-lg-3" href="#top">Contact</a>
                        </li>
